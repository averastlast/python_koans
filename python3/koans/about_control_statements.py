...
class AboutControlStatements(Koan):
    ...
    def test_for_statement_with_tuples(self):
        ...
        self.assertNotRegex(result[0], "Contetant:Answer: 'Blue!'")
        self.assertNotRegex(result[1], "Conteta don't know!'")
        self.assertNotRegex(result[3], "Contetantllow or European Swallow?'")
